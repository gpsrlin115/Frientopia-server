...
교수님께 학업과 관련된 질문을 하기에는 ‘이런걸로 질문을 하기에는 너무 부족한 것 아닌가?’라는 생각이 드는 학생이 많다.   
취미 생활의 경우, 교내에 동아리라는 시스템이 있지만, 가볍게 배우고 취미생활을 즐기고 싶은 학생은 한 학기 동안 꾸준한 참여를 요구하는    
동아리가 부담으로 다가 올 수도 있다. 또한 학교에서는 학습능력 증진, 유대감 등을 목적으로 튜터링 프로그램을 진행하고 있다.   
